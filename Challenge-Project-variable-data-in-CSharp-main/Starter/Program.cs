...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "2":
            ...
            List<string> ListOfDogCharacteristic = new List<string>();
            ...
            while (dogCharacteristic == "")
            {
                ...
                if (readResult != null)
                {
                    ...
                    foreach (string elem in dogCharacteristic.Split(","))
                    {
                        ListOfDogCharacteristic.Add(elem.Trim());
                    }
                    Console.WriteLine();
                }
            }
            ...
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 1].Contains("dog"))
                {
                    ...
                    foreach (string characteristic in ListOfDogCharacteristic)
                    {
                        for (int j = 5; j > -1; j--)
                        {
